...
public class Gt extends COND implements RobotReturnValueNode {

	private EXP left, right;
	private Integer value;

	public Gt(RobotProgramNode root) {
		super(root);
	}

	private static final String LOG = "Gt: ";
	...
	public boolean parse(Scanner s) {
		Parser.require(Parser.GREATERPAT, LOG + "Expecting "
				+ Parser.GREATERPAT.toString(), s);
